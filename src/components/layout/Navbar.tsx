      ...
      {isMobile ? (
        <ScrollArea className="w-full">
          <div className="flex justify-start items-center py-3 px-4 w-max min-w-full">
            <Link 
              to="/" 
              className={`flex flex-col items-center space-y-1 transition-all duration-300 px-6 ${isActive("/") ? "text-primary" : "text-muted-foreground"}`}
            >
              <Home size={18} />
            ...
            <Link 
              to="/demandas" 
              className={`flex flex-col items-center space-y-1 transition-all duration-300 px-6 ${isActive("/demandas") ? "text-primary" : "text-muted-foreground"}`}
            >
              <FileText size={18} />
            ...
            <Link 
              to="/estatisticas" 
              className={`flex flex-col items-center space-y-1 transition-all duration-300 px-6 ${isActive("/estatisticas") ? "text-primary" : "text-muted-foreground"}`}
            >
              <BarChart2 size={18} />
            ...
            <Link 
              to="/equipe" 
              className={`flex flex-col items-center space-y-1 transition-all duration-300 px-6 ${isActive("/equipe") ? "text-primary" : "text-muted-foreground"}`}
            >
              <Users size={18} />
            ...
            <Link 
              to="/settings" 
              className={`flex flex-col items-center space-y-1 transition-all duration-300 px-6 ${isActive("/settings") ? "text-primary" : "text-muted-foreground"}`}
            >
              <Settings size={18} />
