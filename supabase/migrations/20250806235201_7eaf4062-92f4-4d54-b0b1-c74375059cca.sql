...
-- Criar função para verificar se usuário pode ver serviços atribuídos à sua equipe
CREATE OR REPLACE FUNCTION public.can_user_see_team_assigned_services()
RETURNS boolean
LANGUAGE sql
STABLE SECURITY DEFINER
SET search_path = ''
AS $$
  SELECT get_current_user_role() IN ('gestor', 'administrador', 'owner', 'super_admin');
$$;